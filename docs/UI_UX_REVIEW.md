...
| P1 | Dashboard showed a long selected email, including completed records, instead of actionable work. | Replace the email preview with links/counts for review, preparation, manual applications, approved work and destination problems. |
